...
public class Percolation {
    ...
    public Percolation(int n) {
        ...
        // two extra for virtual top (N^2) and bottom (N^2 + 1)
        ...
        baIsOpen = new boolean[iSize][iSize];
    ...
    public void open(int row, int col) {
        ...
        // if on top edge, link to virtual top
            ...
            oFlow.union(to1D(row, col), iSize * iSize);
            oFlowCheck.union(to1D(row, col), iSize * iSize);
        }
        ...
        // if on bottom edge, link to virtual bottom (ONLY for oFlow)
            ...
            oFlow.union(to1D(row, col), iSize * iSize + 1);
        }
    }
    
    // is the site (row, col) open?
    public boolean isOpen(int row, int col) {
        return (baIsOpen[row][col]);
    }
    ...
    public boolean isFull(int row, int col) {
        ...
        return (oFlow.connected(to1D(row, col), iSize * iSize) &&
                oFlowCheck.connected(to1D(row, col), iSize * iSize));
    }
    ...
    // does the system percolate? Checks if virtual top and bottom are connected
    public boolean percolates() {
        return oFlow.connected(iSize * iSize, iSize * iSize + 1);
    }
